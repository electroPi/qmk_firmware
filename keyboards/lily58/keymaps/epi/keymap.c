 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |TT(1) | /Space  /       \Enter \  |TT(2) |RGUI  | LCTL |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  LSFT_T(KC_CAPS), 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, KC_LBRC, KC_RBRC, KC_K, 	KC_M, 	KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, 
					KC_LALT, KC_LGUI, TT(1), KC_SPC, 		KC_ENT, TT(2), KC_RGUI, KC_LCTL
),
...
//),
[_LOWER] = LAYOUT(
KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL, KC_TAB, KC_NO, KC_UP, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_D, KC_CAPS, KC_HOME, KC_PGUP, KC_NO, KC_UP, KC_NO, KC_LCTL, KC_NO, KC_X, KC_C, KC_V, KC_NO, KC_NO, KC_NO, KC_CAPS, KC_END, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_LALT, KC_LGUI, KC_TRNS, KC_SPC, KC_ENT, TT(2), KC_RGUI, KC_RCTL
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_CAPS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_PLUS, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS, KC_LGUI, TT(1), KC_SPC, KC_ENT, KC_TRNS, KC_RGUI, TO(1)
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
  [_ADJUST] = LAYOUT(
  KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGB_TOG, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, RGB_M_T, KC_LALT, KC_LGUI, TT(0), KC_SPC, KC_ENT, TO(0), KC_TRNS, KC_TRNS
  )
};
