 ...
 * |------+------+------+------+------|           |------+------+------+------+------|
 * |  F11 |  F12 |      |      |      |           | Mute | Vol- | Vol+ | Mail | Calc |
 * |------+------+------+------+------|           |------+------+------+------+------|
 * | Reset|      |      |      | Pscr |           | Prev | Stop | Play | Next |caltde|
 * `----------------------------------'           `----------------------------------'
 *             ,-------------------------.    ,------,-----------------.
 *             | Shift| LOWER/Bksp| CTL  |    | Alt  | DEL/RAISE| LGUI |
 *             | Caps |           |      |    |      |          |      |
...
[_ADJUST] =  LAYOUT( \
  ...
  KC_F11,  KC_F12,  _______, _______, _______,      KC_MUTE, KC_VOLD, KC_VOLU, KC_MAIL, KC_CALC,
  RESET,   _______, _______, _______, KC_PSCR,      KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, CALTDEL,
                    _______, _______, _______,      _______,  _______, _______
)
};
